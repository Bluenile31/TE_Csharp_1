...
namespace TE_Csharp_1
{
    public class Bank
    {
        ...
        public static void Main(string[] args)
        {
            ...
            i.GetInterest1("HDFC Bank", 1, 1, 3.50);

            Console.WriteLine("Bank 2:");
            id -= i.GetInterest2;
            i.GetInterest2("SBI Bank", 1, 1, 2.70);

            Console.WriteLine("Bank 3:");
            id -= i.GetInterest3;
            i.GetInterest3("Kotak Mahindr Bank", 1, 1, 3.50);

            Console.WriteLine("Bank 4:");
            id -= i.GetInterest4;
            i.GetInterest4("Axis Bank", 1, 1, 3.00);

            Console.WriteLine("Bank 5:");
            id -= i.GetInterest5;
            i.GetInterest5("SBI Bank", 1, 1, 3.50);
        }
    }
}
